...
public class Match implements Serializable {
    ...
    public String toString() {
        return "Match [city=" + city + ", date=" + date + ", eliminator=" + eliminator + ", id=" + id + ", matchWinner="
                + matchWinner + ", playerOfMatch=" + playerOfMatch + ", resultDecisionMethod=" + resultDecisionMethod
                + ", resultMargin=" + resultMargin + ", resultType=" + resultType + ", team1=" + team1 + ", team2="
                + team2 + ", tossDecision=" + tossDecision + ", tossWinner=" + tossWinner + ", umpire1=" + umpire1
                + ", umpire2=" + umpire2 + ", venue=" + venue + "]";
    }
}
